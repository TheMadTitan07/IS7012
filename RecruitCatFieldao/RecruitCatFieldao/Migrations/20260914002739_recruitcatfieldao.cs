...
{
    /// <inheritdoc />
    public partial class recruitcatfieldao : Migration
    {
        /// <inheritdoc />
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    IsActivelyRecruiting = table.Column<bool>(type: "bit", nullable: false),
                    CurrentlyRecruitingPosition = table.Column<string>(type: "nvarchar(max)", nullable: false),
